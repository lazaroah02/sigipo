...
class TipoHistologicoChoices(models.IntegerChoices):
    ...
    CARCINOMA_CELULAS_ESCAMOSAS_NO_QUERATINIZANTE = 3, "carcinoma de células escamosas, no queratinizante"
    CARCINOMA_CELULAS_ESCAMOSAS_BASALOIDE = 4, "carcinoma de células escamosas, basaloide"
    CARCINOMA_CELULAS_ESCAMOSAS_VERRUCOSO = 5, "carcinoma de células escamosas, verrucoso"
    CARCINOMA_CELULAS_ESCAMOSAS_PAPILAR = 6, "carcinoma de células escamosas, papilar"
    CARCINOMA_CELULA_ESCAMOSAS_LYMPHOEPITHELIOMA_LIKE = 7, "carcinoma de célula escamosas, lymphoepithelioma-like"
    CARCINOMA_CELULAS_ESCAMOSAS_ESCAMOTRANSICIONAL = 8, "carcinoma de células escamosas, escamotransicional"
    ADENOCARCINOMA_ENDOCERVICAL_TIPO_USUAL = 9, "Adenocarcionoma endocervical, tipo usual"
    CARCINOMA_MUCINOUS = 10, "Carcinoma mucinous"
    CARCINOMA_MUCINOUS_TIPO_INTESTINAL = 11, "Carcinoma mucinous, tipo intestinal"
    CARCINOMA_MUCINOUS_TIPO_CELULAS_EN_ANILLO_DE_SELLO = 12, "Carcinoma mucinous, tipo células en anillo de sello"
    ...
    ADENOCARCINOMA_MEZCLADO_CON_CARCINOMA_NEUROENDOCRINO = 19, "Adenocarcinoma mezclado con carcinoma neuroendocrino"
    CARCINOMA_ADENOSQUAMOUS = 20, "Carcinoma Adenosquamous"
    CARCINOMA_ADENOSQUAMOUS_VARIANTE_DE_LA_CELULA_VIDRIOSA = 21, "Carcinoma Adenosquamous, variante de la célula vidriosa"
    CARCINOMA_ADENOIDEO_QUISTICO = 22, "Carcinoma adenoideo quistico"
    CARCINOMA_BASAL_ADENOIDEO = 23, "Carcinoma basal adenóideo"
    CARCINOMA_NEUROENDOCRINO_DE_CELULAS_PEQUENAS = 24, "Carcinoma neuroendocrino de células pequeñas"
    CARCINOMA_NEUROENDOCRINE_DE_CELULAS_GRANDES = 25, "Carcinoma neuroendocrine de células grandes"
    CARCINOMA_INDIFERENCIADO = 26, "Carcinoma indiferenciado"
    CARCINOSARCOMA = 27, "Carcinosarcoma"
    OTRO_TIPO_HISTOLOGICO = 28, "otro tipo histologico que no figura en la lista (especifique)"
    CARCINOMA_DE_TIPO_QUE_NO_PUEDE_SER_DETERMINADO = 29, "Carcinoma de tipo que no puede ser determinado"
...
class ReseccionChoices(models.IntegerChoices):
    ...
    SALPINGO_OOPHORECTOMY_LADO_NO_ESPECIFICADO = 8, "Salpingo-oophorectomy, lado no especificado"
    OOPHORECTOMIA_DERECHA = 9, "Oophorectomía derecha"
    OOPHORECTOMIA_IZQUIERDO = 10, "Oophorectomía izquierdo"
    OOPHORECTOMIA_NO_TOME_PARTIDO_ESPECIFICADO = 11, "Oophorectomía, no tome partido especificado"
