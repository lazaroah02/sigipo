...
class RelacionTumorUnionChoices(models.IntegerChoices):
    TUBULAR = 1, "el tumor está enteramente ubicado dentro del esófago tubular y no involucra la unión esophagogastrica"
    DISTAL = 2, "el punto medio del tumor yace en el esófago del distal y el tumor involucra la unió esophagogastrica"
    UNION = 3, "el punto medio del tumor está localizado en la unión esophagogastrica"
    PROXIMAL = 4, "el punto medio del tumor es 2 cm o menos en el estómago  proximal o el cardias y el tumor involucra la unión esophagogastrica"
    NO_ESPECIFICADO = 5, "no especificado"
...
class TipoHistologiaChoices(models.IntegerChoices):
    ...
    CARCINOMA_INDIFERENCIADO_GLANDULAR = 5, "Carcinoma indiferenciado con componente glandular"
    ...
    CARCINOMA_INDIFERENCIADO_ESCAMOSO = 11, "Carcinoma indiferenciado con componente escamoso"
    CARCINOMA_INDIFERENCIADO = 12, "Carcinoma indiferenciado"
    CARCINOMA_NEUROENDOCRINO_CELULA_GRANDE = 13, "Carcinoma  neuroendocrino de  célula grande"
    CARCINOMA_NEUROENDOCRINO_CELULA_PEQUENAS = 14, "Carcinoma neuroendocrino de  célula pequeñas"
    CARCINOMA_NEUROENDOCRINO_POBREMENTE_DIFERENCIADO = 15, "Carcinoma Neuroendocrino (pobremente diferenciado)"
...
class MargenProximalChoices(models.IntegerChoices):
    ...
    INVOLUCRADO_DISPLASIA_ESCAMOSA_BAJO = 5, "involucrado por displasia escamosa de bajo grado"
    INVOLUCRADO_DISPLASIA_ESCAMOSA_ALTO = 6, "involucrado por displasia escamosa de alto grado"
    INVOLUCRADO_DISPLASIA_GLANDULAR_BAJO = 7, "involucrado por displasia glandular de bajo grado"
    INVOLUCRADO_DISPLASIA_GLANDULAR_ALTO = 8, "involucrado por displasia glandular de alto grado"
    INVOLUCRADO_METAPLASIA_INTESTINAL = 9, "involucrado por metaplasia intestinal (el esófago Barrett) sin displasia"
...
class MargenMucosalChoices(models.IntegerChoices):
    ...
    NO_INVOLUCRADO_INVASIVO = 3, "no involucrado por carcinoma invasivo"
    INVOLUCRADO_DISPLASIA = 4, "involucrado por displasia"
    INVOLUCRADO_DISPLASIA_ESCAMOSO_BAJO = 5, "involucrado por displasia escamoso de bajo grado"
    INVOLUCRADO_DISPLASIA_ESCAMOSO_ALTO = 6, "involucrado por displasia escamoso de alto grado"
    INVOLUCRADO_DISPLASIA_GLANDULAR_BAJO = 7, "involucrado por displasia glandular de bajo grado"
    INVOLUCRADO_DISPLASIA_GLANDULAR_ALTO = 8, "involucrado por displasia glandular de alto grado"
    INVOLUCRADO_METAPLASIA_INTESTINAL = 9, "involucrado por metaplasia intestinal (el esófago Barrett) sin displasia"
