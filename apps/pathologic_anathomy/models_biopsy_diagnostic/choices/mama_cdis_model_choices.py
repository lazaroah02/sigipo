...
class HistoriaClinicaActualChoices(models.TextChoices):
    ...
    HALLAZGOS_RADIOLOGICOS_MASA_O_DISTORSION = "MD", "Hallazgos Radiológicos. Masa o distorsión arquitectural"
    HALLAZGOS_RADIOLOGICOS_CALCIFICACIONES = "CA", "Hallazgos Radiológicos. Calcificaciones"
