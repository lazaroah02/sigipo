...
class TipoHistologicoChoices(models.IntegerChoices):
    ...
    CARCINOMA_CON_ESTROMA_LINFOIDE = (
        9,
        "carcinoma con estroma linfoide (el carcinoma medular)",
    )
    CARCINOMA_NEUROENDOCRINO_DE_CELULA_GRANDE = (
        10,
