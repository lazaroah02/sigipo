...
class TipoMuestraTiroidesChoice(IntegerChoices):
    ...
    lobectomia_derecha_istmectomia = (
        7,
        "Lobectomía derecha con istmectomía (hemitiroidectomía)",
    )
    lobectomia_izquierda_istmectomia = (
        8,
        "Lobectomía izquierda con istmectomía (hemitiroidectomía)",
    )
    lobulo_derecho_lobectomia_parcial_izquierda = (
        9,
        "Lóbulo derecho con lobectomía parcial izquierda (tiroidectomía subtotal o casi total)",
    )
    lobulo_izquierdo_lobectomia_parcial_derecha = (
        10,
...
class CarcinomaPapilarChoice(IntegerChoices):
    ...
    neoplasia_folicular_noinvasiva = (
        10,
