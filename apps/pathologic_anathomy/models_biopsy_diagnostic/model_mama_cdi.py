...
class MamaCDIBiopsyDiagnostic(models.Model):
    ...
    medico_asistencia = models.CharField(
        verbose_name="Médico de asistencia", null=True, blank=True, max_length=5000
    )
    ...
    reporte_tipo_muestra = models.CharField(
        verbose_name="Tipo de Muestra", null=True, blank=True, max_length=5000
    )
    ...
    posicion = models.IntegerField(
        choices=mama_cdi_model_choices.PosicionChoices.choices, verbose_name="Posición"
    )
    ...
    metodo_localizacion = models.CharField(
        verbose_name="Método de localización", max_length=5000
    )
    ...
    num_focos_presentes = models.IntegerField(
        verbose_name="Número de focos presentes", blank=True, null=True
    )
    ...
    tumor_size = models.CharField(
        verbose_name="Tamaño del tumor(es)(mm o cm)", max_length=100
    )
    ...
    alteraciones = models.CharField(
        verbose_name="Alteraciones", null=True, blank=True, max_length=5000
    )
    # Músculo
    musculo_presente = models.BooleanField(verbose_name="Musculo presente")
    ...
    si_ganglio_linfatico_report = models.CharField(
        max_length=100000, blank=True, null=True, verbose_name=""
    )
    ...
    descripcion = models.CharField(
        verbose_name="Descripción", null=True, blank=True, max_length=5000
    )
    ...
    relacion_cortes = models.CharField(
        verbose_name="Relación de cortes", null=True, blank=True, max_length=5000
    )
    # Reportado por
    reportado_por = models.CharField(
        verbose_name="Reportado por", null=True, blank=True, max_length=5000
    )
    ...
    cuadrantes_involucrados = models.CharField(
        verbose_name="Cuadrantes involucrados", null=True, blank=True, max_length=5000
    )
    ...
    max_size_by_tumor = models.CharField(
        verbose_name="Para cada tumor identificado, tamaño máximo(mm)", max_length=5000
    )
    ...
    grado_histologico = models.CharField(
        max_length=1000, verbose_name="Grado histológico(Nottingham Histologic Score)"
    )
    # Diferenciación Glandular (Acinar)/Tubular
    diferenciacion_glandular = models.CharField(
        max_length=1000, verbose_name="Diferenciación Glandular (Acinar)/Tubular"
    )
    ...
    necrosis = models.IntegerField(
        choices=mama_cdi_model_choices.NecrosisChoices.choices, verbose_name="Necrosis"
    )
    ...
    num_bloques_cdis = models.IntegerField(verbose_name="Número de bloques con CDIS")
    ...
    grado = models.IntegerField(
        choices=mama_cdi_model_choices.GradoChoices.choices, verbose_name="Grado"
    )
    ...
    # Invasión a músculo
    invasion_musculo = models.BooleanField(verbose_name="Invasión a músculo")
    ...
    # Anterior:
    margen_anterior = models.CharField(max_length=1000, verbose_name="Anterior")
    # Posterior:
    margen_posterior = models.CharField(
        max_length=1000, verbose_name="Posterior", blank=True, null=True
    )
    # Superior:
    margen_superior = models.CharField(
        max_length=1000, verbose_name="Superior", blank=True, null=True
    )
    # Inferior:
    margen_inferior = models.CharField(
        max_length=1000, verbose_name="Inferior", blank=True, null=True
    )
    # Medial:
    margen_medial = models.CharField(
        max_length=1000, verbose_name="Medial", blank=True, null=True
    )
    # Lateral:
    margen_lateral = models.CharField(
        max_length=1000, verbose_name="Lateral", blank=True, null=True
    )
    ...
    distancia = models.FloatField(verbose_name="Distancia a los márgenes (mm): ")
    # Para los márgenes positivos, especificar la  extensión (unifocal, multifocal, o extensivo):
    # Anterior:
    margen_anterior_cdis = models.CharField(
        max_length=1000, verbose_name="Anterior", blank=True, null=True
    )
    # Posterior:
    ...
    num_gang_linf_reg_not_send = models.IntegerField(
        verbose_name="Ganglios Linfáticos Regionales no enviados", blank=True, null=True
    )
    # No encontrados
    ...
    num_gang_linf_reg_examinated = models.IntegerField(
        verbose_name="Ganglios Linfáticos Regionales examinados", blank=True, null=True
    )
    ...
    otros_estudios_ihq = models.CharField(
        blank=True, null=True, verbose_name="Otros estudios: IHQ", max_length=5000
    )
    comentarios = models.CharField(
        blank=True, null=True, verbose_name="Comentarios", max_length=5000
    )
    diagnosticado_por = models.CharField(
        blank=True, null=True, verbose_name="Diagnosticado por", max_length=1000
    )
    ...
    def __str__(self):
        return (
            f"Diagnostico de la biopcia de tipo mama(cdi) de la biopcia: {self.biopsy}"
        )
