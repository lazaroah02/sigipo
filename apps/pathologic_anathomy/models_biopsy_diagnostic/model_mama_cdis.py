...
class MamaCDISBiopsyDiagnostic(models.Model):
    ...
    medico_asistencia = models.CharField(
        verbose_name="Médico de asistencia", max_length=1000
    )
    ...
    posicion = models.IntegerField(
        verbose_name="Posicion", choices=mama_cdis_model_choices.PosicionChoices.choices
    )
    otra_posicion = models.CharField(
        verbose_name="Otra Posición", max_length=5000, blank=True, null=True
    )

    # Tamaño (Extensión) del CDIS
    # Extensión máxima del CDI (mm)
    extension_maxima_cdi = models.FloatField(
        verbose_name="Extensión máxima del CDI (mm)", blank=True, null=True
    )
    # Dimensiones adicionales del CDI (mm)
    dimensiones_adicionales_cdi = models.FloatField(
        verbose_name="Extensiones adicionales del CDI (mm)", blank=True, null=True
    )
    # Número de bloques son CDIS:
    num_bloques_cdi = models.IntegerField(
        verbose_name="Número de bloques son CDIS", blank=True, null=True
    )
    # Número de bloques examinados:
    num_bloques_examinados = models.IntegerField(
        verbose_name="Número de bloques examinados", blank=True, null=True
    )
    # Reportado por
    reportado_por = models.CharField(
        verbose_name="Reportado por", blank=True, null=True, max_length=1000
    )
    ...
    patron_arquitectural_otro = models.CharField(
        verbose_name="Otro Patron Arquitectural", max_length=5000, blank=True, null=True
    )
    ...
    necrosis = models.IntegerField(
        verbose_name="Necrosis", choices=mama_cdis_model_choices.NecrosisChoices.choices
    )
    ...
    margen_especificado_especific = models.CharField(
        verbose_name="Margen especificado", max_length=5000, blank=True, null=True
    )
    ...
    num_ganglios_linfaticos_exam = models.IntegerField(
        verbose_name=" Número de ganglios linfáticos examinados", blank=True, null=True
    )
    ...
    def __str__(self):
        return (
            f"Diagnostico de la biopcia de tipo mama(cdis) de la biopcia: {self.biopsy}"
        )
