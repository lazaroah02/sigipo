...
class GynecologyBiopsyDiagnostic(models.Model):
    ...
    procedimiento_otro = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Otro procedimiento(especifique): "
    )
    ...
    size_no_determinado = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Las dimensiones no pueden ser determinadas(explique): "
    )
    ...
    tipo_histologico_otro = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Otro tipo histologico que no figura en la lista (especifique): "
    )
    ...
    profundidad_no_determinada = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="La profundidad no puede ser determinada(explique):"
    )
    extensio_horizontal = models.FloatField(
        verbose_name="Extensión horizontal(mm)",
        blank=True,
        null = True
    )
    longitud_longitudinal  = models.FloatField(
        verbose_name="Longitud longitudinal(mm)",
        blank=True,
        null = True
    )
    extension_longitud_no_determinada = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="La extensión no puede ser determinada(explique):"
    )
    extensio_horizontal = models.FloatField(
        verbose_name="Extensión horizontal(mm)",
        blank=True,
    ...
    margen_endocervical_no_evaluado_explique = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Margen Endocervical no puede ser evaluado (explique):"
    )
    margen_endocervical_no_afectado = models.BooleanField(
        default=False,
        verbose_name = "Margen Endocervical no afectado"
    )
    ...
    margen_ectocervical_no_evaluado_explique = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Margen Ectocervical no puede ser evaluado (explique):"
    )
    margen_ectocervical_no_afectado = models.BooleanField(
        default=False,
        verbose_name = "Margen Ectocervical no afectado"
    )
    ...
    margen_profundo_no_evaluado_explique = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Margen Profundo no puede ser evaluado (explique):"
    )
    margen_profundo_no_afectado = models.BooleanField(
        default=False,
        verbose_name = "Margen Profundo no afectado"
    )
    ...
    exenteracion_pelvica_especifique = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Exenteración pélvica(especifique órganos incluidos): "
    )
    otra_reseccion_especifique = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Otra Resección(especifique):"
    )
    ...
    otro_tipo_hysterectomy = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Otro del + (especifique): "
    )
    ...
    afectacion_otro_organo = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Afectación de otro órgano(especifique):"
    )
    afectacion_no_determinada = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Afectación no puede ser determinada(explique):"
    )
    ...
    ectocervical_margin_no_evaluado_especif = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Ectocervical Margin no puede ser evaluado (explique)"
    )
    ...
    ectocervical_margin_posicion_specify1 = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="El + la posición(especificar):"
    )
    ...
    ectocervical_especifique_posicion = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Especifique posición(si es posible)"
    )
    ...
    radial_margin_no_evaluado_especif = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="Radial Margin no puede ser evaluado (explique)"
    )
    ...
    num_no_determinado_especif = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="El número no puede ser determinado (explique):"
    )
    ...
    num_nodos_no_determinado_especif = models.CharField(
        max_length=5000, blank=True, null=True, verbose_name="El número de nodos no puede ser determinado (explique):"
    )
