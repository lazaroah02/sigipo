...
class Head(models.Model):
    ...
    #tipo de muestra
    biopsy = models.OneToOneField("pathologic_anathomy.BiopsyRequest", on_delete=models.CASCADE, related_name = "biopsy_diagnostic_head")
    ...
    ganglio_linfatico_encontrado = models.BooleanField(
        default = False,
        verbose_name="Ganglio linfático presente o encontrado"
        )
