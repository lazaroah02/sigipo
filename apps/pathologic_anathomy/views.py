...
BIOPSY_TYPES = {
    ...
    2: {
        "model": model_neck.NeckBiopsyDiagnostic,
        "form": form_neck.NeckBiopsyDiagnosticForm,
    },  # Biopsia de Cuello
    3: {
        "model": model_stomac.StomacBiopsyDiagnostic,
        "form": form_stomac.StomacBiopsyDiagnosticForm,
    },  # Biopsia Digestivo
    4: {
        "model": model_gynecology.GynecologyBiopsyDiagnostic,
        "form": form_gynecology.GynecologyBiopsyForm,
    },  # Biopsia de Ginecologia
    5: {
        "model": model_linfoma.LinfomaBiopsyDiagnostic,
        "form": form_linfoma.LinfomaBiopsyDiagnosticForm,
    },  # Biopsia de Linfoma
    6: {
        "model": model_mama_cdi.MamaCDIBiopsyDiagnostic,
        "form": form_mama_cdi.MamaCDIBiopsyForm,
    },  # Biopsia de Mama CDI
    7: {
        "model": model_mama_cdis.MamaCDISBiopsyDiagnostic,
        "form": form_mama_cdis.MamaCDISBiopsyForm,
    },  # Biopsia de Mama CDIS
}
