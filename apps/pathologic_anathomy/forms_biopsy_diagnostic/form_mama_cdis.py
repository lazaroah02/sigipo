...
from apps.pathologic_anathomy.models_biopsy_diagnostic.model_mama_cdis import (
    MamaCDISBiopsyDiagnostic,
)
...
class MamaCDISBiopsyForm(ModelForm):
    ...
    extension_maxima_cdi = FloatField(
        label="Extensión máxima del CDI (mm)", required=False
    )
    # Dimensiones adicionales del CDI (mm)
    dimensiones_adicionales_cdi = FloatField(
        label="Extensiones adicionales del CDI (mm)", required=False
    )
    # Número de bloques son CDIS:
    num_bloques_cdi = IntegerField(label="Número de bloques son CDIS", required=False)
    # Número de bloques examinados:
    num_bloques_examinados = IntegerField(
        label="Número de bloques examinados", required=False
    )
    # Reportado por
    reportado_por = CharField(label="Reportado por", required=False, max_length=1000)
    ...
    size_extension = CharField(
        max_length=1000, label="Tamaño y extensión:", required=True
    )
    ...
    distancia_margen_mas_cercano = FloatField(
        label="Distancia del margen más cercano(mm)", required=True
    )
    # Márgen mas cercano
    ...
    diastancia_margen_superior = FloatField(
        label="Distancia al márgen superior(mm)", required=True
    )
    diastancia_margen_inferior = FloatField(
        label="Distancia al márgen inferior(mm)", required=True
    )
    diastancia_margen_medial = FloatField(
        label="Distancia al márgen medial(mm)", required=True
    )
    diastancia_margen_lateral = FloatField(
        label="Distancia al márgen lateral(mm)", required=True
    )
    diastancia_margen_anterior = FloatField(
        label="Distancia al márgen anterior(mm)", required=True
    )
    diastancia_margen_posterior = FloatField(
        label="Distancia al márgen posterior(mm)", required=True
    )
    ...
    num_ganglios_linfaticos_exam = IntegerField(
        label=" Número de ganglios linfáticos examinados", required=False
    )
