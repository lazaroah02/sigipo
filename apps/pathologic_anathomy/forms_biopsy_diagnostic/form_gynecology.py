...
from apps.pathologic_anathomy.models_biopsy_diagnostic.model_gynecology import (
    GynecologyBiopsyDiagnostic,
)
...
class GynecologyBiopsyForm(ModelForm):
    ...
    tumor_max_size = FloatField(
        label="La máxima dimensión del tumor(centímetros)", required=False
    )
    additional_tumor_size = FloatField(
        label="Las dimensiones adicionales del tumor(centímetros)", required=False
    )
    ...
    extensio_horizontal = FloatField(label="Extensión horizontal(mm)", required=False)
    longitud_longitudinal = FloatField(
        label="Longitud longitudinal(mm)", required=False
    )
    ...
    anchura_circunferencial = FloatField(
        label="Anchura circunferencial(mm)", required=False
    )
    ...
    margen_endocervical_distancia_carcinoma = FloatField(
        label="La distancia del carcinoma al margen(mm)", required=False
    )
    ...
    margen_ectocervical_distancia_carcinoma = FloatField(
        label="La distancia del carcinoma al margen ectocervical(mm)", required=False
    )
    ...
    margen_profundo_distancia_carcinoma = FloatField(
        label="La distancia del carcinoma al margen profundo(mm)", required=False
    )
    ...
    num_nodos_con_metastasis = IntegerField(
        label="El número de Nodos con Metástasis (excluye a ITCs):", required=False
    )
    ...
    num_nodos_senalizador_exami = IntegerField(
        label="Numere de Nodos del Señalizador Examinados:", required=False
    )
