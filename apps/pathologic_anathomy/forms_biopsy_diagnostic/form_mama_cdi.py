...
from apps.pathologic_anathomy.models_biopsy_diagnostic.model_mama_cdi import MamaCDIBiopsyDiagnostic
...
class MamaCDIBiopsyForm(ModelForm):
    ...
    especimen_size = CharField(
        max_length=100,
        label = "Tamaño del espécimen(mm o cm)",
        required = True
    )
    ...
    num_focos_presentes = IntegerField(
        label = "Número de focos presentes",
        required = False
    )
    ...
    ganglios_linfaticos_no_centinelas = IntegerField(
        label = "Ganglios linfáticos no centinelas",
        required = False
    )     
    #Número total de ganglios 
    num_total_ganglios = IntegerField(
        label = "Número total de ganglios",
        required = False
    )
    #Tamaño promedio (mm o cm )
    average_size = FloatField(
        label = "Tamaño promedio (mm o cm )",
        required=False
    )
    #Descripción
    ...
    num_total_focos_tumorales = IntegerField(
        label = "Número total de focos tumorales",
        required = True
    )
    ...
    #Índice Mitótico 
    indice_mitotico = FloatField(
        label = "Indice Mitótico",
        required = True
    )
    ...
    adittional_size = FloatField(
        label = "Dimensions adicionales (millimeters)",
        required=True
    )
    #Número de bloques con CDIS
    num_bloques_cdis = IntegerField(
        label="Número de bloques con CDIS",
        required=True
    )
    ...
    pezones_afectados = IntegerField(
        label = "Pezones Afectado por CDIS (Enf Paget)",
        required=True
    )
    #Invasión a músculo
    ...
    distancia_a_los_margenes = FloatField(
        label = "Distancia a los Márgenes",
        required=True
    )
    #Para los márgenes positivos, especificar la  extensión (unifocal, multifocal, o extensivo):
    #Anterior:
    margen_anterior = CharField(
        max_length = 1000,
        label = "Anterior",
        required=True
    )
    #Posterior:
    margen_posterior = CharField(
        max_length = 1000,
        label = "Posterior",
        required = False
    )
    #Superior: 	
    margen_superior = CharField(
        max_length = 1000,
        label = "Superior",
        required = False
    )
    #Inferior:	
    margen_inferior = CharField(
        max_length = 1000,
        label = "Inferior",
        required = False
    )
    #Medial:
    margen_medial = CharField(
        max_length = 1000,
        label = "Medial",
        required = False
    )
    #Lateral:
    margen_lateral = CharField(
        max_length = 1000,
        label = "Lateral",
        required = False
    )
    ...
    distancia = FloatField(
        label = "Distancia a los márgenes (mm): ",
        required=True
    )
    #Para los márgenes positivos, especificar la  extensión (unifocal, multifocal, o extensivo):
    #Anterior:
    margen_anterior_cdis = CharField(
        max_length = 1000,
        label = "Anterior",
        required=False
    )
    ...
    #Superior: 	
    margen_superior_cdis = CharField(
        max_length = 1000,
        label = "Superior",
        required=False
    )
    #Inferior:	
    margen_inferior_cdis = CharField(
        max_length = 1000,
        label = "Inferior",
        required=False
    )
    #Medial:
    margen_medial_cdis = CharField(
        max_length = 1000,
        label = "Medial",
        required=False
    )
    #Lateral:
    margen_lateral_cdis = CharField(
        max_length = 1000,
        label = "Lateral",
        required=False
    )
    ...
    num_gang_linf_reg_not_send = IntegerField(
        label = "Ganglios Linfáticos Regionales no enviados",
        required=False
    )
    #No encontrados
    num_gang_linf_reg_not_found = IntegerField(
        label = "Ganglios Linfáticos Regionales no encontrados",
        required=False
    )
    ...
    num_gang_linf_reg_examinated = IntegerField(
        label = "Ganglios Linfáticos Regionales examinados",
        required = False
    )
    ...
    num_gang_centinelas_examinated = IntegerField(
        label = "Número de  ganglios centinelas examined(si proceder):",
        required= False
    )
