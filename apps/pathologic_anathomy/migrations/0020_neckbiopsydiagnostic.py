            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (2, "Medio esófago, el superior esófago torácico"),
                            (3, "Medio esófago, el intermedio esófago torácico"),
                            (4, "Medio esófago, no especificado en otra forma"),
                            (5, "Esófago distal ( esófago torácico)"),
                            (6, "Unión Esophagogastrica (EGJ)"),
                            (7, "Estómago /cardias Proximal"),
                            (8, "otro (especifique):"),
                            (9, "El esófago, no especificado en otra forma"),
                        ],
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (
                                3,
                                "el punto medio del tumor está localizado en la unión esophagogastrica",
                            ),
                            (
                                4,
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        choices=[
                            (1, "Adenocarcinoma"),
                            (2, "Carcinoma  adenóideo quistito"),
                            (3, "Carcinoma Mucoepidermoide"),
                            (4, "Carcinoma mixto  adenoneuroendocrino"),
                            (5, "Carcinoma indiferenciado con componente glandular"),
                            (6, "Carcinoma de  célula escamoso"),
                            (7, "Carcinoma de la célula escamoso Basaloide"),
                            (8, "Carcinoma Adenoescamoso"),
                            (9, "Carcinoma de celulas fusiforme (escamoso)"),
                            (10, "Carcinoma Verrucoso (escamoso)"),
                            (11, "Carcinoma indiferenciado con componente escamoso"),
                            (12, "Carcinoma indiferenciado"),
                            (13, "Carcinoma  neuroendocrino de  célula grande"),
                            (14, "Carcinoma neuroendocrino de  célula pequeñas"),
                            (15, "Carcinoma Neuroendocrino (pobremente diferenciado)"),
                            (
                                16,
                                "Otro tipo  histológico que no figura en la lista (especifique):",
                            ),
                            (17, "Carcinoma, el tipo no puede ser determinado"),
                        ],
                        null=True,
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        choices=[
                            ...
                            (4, "involucrado por displasia"),
                            (5, "involucrado por displasia escamosa de bajo grado"),
                            (6, "involucrado por displasia escamosa de alto grado"),
                            (7, "involucrado por displasia glandular de bajo grado"),
                            (8, "involucrado por displasia glandular de alto grado"),
                            (
                                9,
                ...
                (
                    "otros_margenes_sophagectomia_y_esophagogastrectomia",
                    models.CharField(
                        blank=True,
                        max_length=1000,
                        null=True,
                ...
                (
                    "otros_margenes_sophagectomia_y_esophagogastrectomia_especificaciones",
                    models.IntegerField(
                        blank=True,
                        choices=[
                            (1, "no puede ser evaluado"),
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        choices=[
                            ...
                            (3, "no involucrado por carcinoma invasivo"),
                            (4, "involucrado por displasia"),
                            (5, "involucrado por displasia escamoso de bajo grado"),
                            (6, "involucrado por displasia escamoso de alto grado"),
                            (7, "involucrado por displasia glandular de bajo grado"),
                            (8, "involucrado por displasia glandular de alto grado"),
                            (
                                9,
                ...
                (
                    "otros_margenes_reseccion_endoscopica",
                    models.CharField(
                        blank=True,
                        max_length=1000,
                        null=True,
                ...
                (
                    "otros_margenes_reseccion_endoscopica_especificaciones",
                    models.IntegerField(
                        blank=True,
                        choices=[
                            (1, "no puede ser evaluado"),
