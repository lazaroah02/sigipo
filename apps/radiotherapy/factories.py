...
from factory.fuzzy import FuzzyFloat, FuzzyText, FuzzyInteger, FuzzyChoice, FuzzyDate
...
class MedicalTurnFactory(DjangoModelFactory):
    ...
    date_culmination_treatment = FuzzyDate(dt.date(1990, 1, 1), end_date=dt.date.today())
