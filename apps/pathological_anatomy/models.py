...
class Pathology(TimeStampedModel):
    ...
    authopsy_number = CharField(
        verbose_name="Número de Autopsia", max_length=50, primary_key=True, default=None
    )
    ...
    eval_speciality = TextField(
        verbose_name="Egreso (Especialidad)", null=True, blank=True
    )
    eviseration_date = DateField(
        verbose_name="Fecha de eviseración", null=True, blank=True
    )
    ...
    dignostic_date = DateField(
        verbose_name="Fecha de diagnóstico", null=True, blank=True
    )
    ...
    respiratory_aparatus = TextField(
        verbose_name="Aparato Respiratorio", null=True, blank=True
    )
    cardiovascular_aparatus = TextField(
        verbose_name="Aparato Cardiovascular", null=True, blank=True
    )
    digestive_aparatus = TextField(
        verbose_name="Aparato Disgestivo", null=True, blank=True
    )
    ...
    hemollymphoietic_aparatus = TextField(
        verbose_name="Aparato Hemolinfopoyético", null=True, blank=True
    )
    endocrine_system = TextField(
        verbose_name="Sistema Endocrino", null=True, blank=True
    )
    osteo_mio_articular_system = TextField(
    ...
    cerebellum_stream_w = FloatField(
        verbose_name="Peso Cerebelo y Tallo", null=True, blank=True
    )
    right_lung_w = FloatField(
        verbose_name="Peso del Pulmón derecho", null=True, blank=True
    )
    left_lung_w = FloatField(
        verbose_name="Peso del Pulmón izquierdo", null=True, blank=True
    )
    ...
    r_kidney_w = FloatField(
        verbose_name="Peso del Riñón derecho", null=True, blank=True
    )
    r_kidney_v = FloatField(
        verbose_name="Volumen del Riñón derecho", null=True, blank=True
    )
    l_kidney_w = FloatField(
        verbose_name="Peso del Riñón izquierdo", null=True, blank=True
    )
    l_kidney_v = FloatField(
        verbose_name="Volumen del Riñón izquierdo", null=True, blank=True
    )
    ...
    other_anatopathologic_dignose = TextField(
        verbose_name="Otros Diagnósticos Anatopatológicos", null=True, blank=True
    )

    ########################################################################
    observation_epicrisis = TextField(
        verbose_name="Observaciones (Epicrisis)", null=True, blank=True
    )
